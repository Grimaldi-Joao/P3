        ...
        if(loggedUser != null){
            ...
            while(userIndex != 0){
                ...
                switch(userIndex){
                    ...
                    System.out.println("Seu balanço de conta atual é de " + loggedUser.getCredit());
                    break;
                    case 1:
